  ...
  },
  {
    render: () => {
      return (
        <>
          <h3>
            "I was very excited whilst on a visit to New York City from
            Australia in 2016 to be able to line up a lesson with my favourite
            jazz recorder player, Tali Rubinstein. Tali was supportive and
            encouraging and gave me lots of jazz practice ideas which I'm still
            using 4 years later!"
          </h3>
          <h4>- Marion Lustig (Australia)</h4>
        </>
      );
    },
  },
  ...
  },
  {
    render: () => {
      return (
        <>
          <h3>
            "Tali Rubinstein meets the students at their current level and
            accompanies the eager jazz beginners with empathy in their first
            steps."
          </h3>
          <h4>- Sina Bayer (Germany)</h4>
        </>
      );
    },
  },
