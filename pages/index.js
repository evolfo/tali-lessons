...
const Home = () => {
  return (
    <>
      <Head>
        {/* <title>Online Recorder Lessons with Tali Rubinstein - Music Lessons Online</title>
        ...
        <meta property="og:title" content="Online Recorder Lessons with Tali Rubinstein" />
