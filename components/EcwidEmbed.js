...
const EcwidEmbed = () => {
  ...
  script.src = 'https://app.ecwid.com/script.js?36360190&data_platform=code&data_date=2022-02-09';
  script.defer = true;
  ...
  return (
    <>
      <Container id="lesson-bundles" className="bundle-container">
        ...
        <p>Get 5% off 5 lessons, 8% off 10 lessons, or 12% off 20 lessons by choosing one of the options below.<br />
